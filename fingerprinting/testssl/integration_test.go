...
func TestTestSSLIntegration(t *testing.T) {
	// Skip if testssl.sh binary is not available
	...
	// Test basic SSL/TLS testing
	t.Run("BasicSSLTest", func(t *testing.T) {
		if testing.Short() {
